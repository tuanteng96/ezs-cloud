...
function Header(props) {
  ...
  return (
    <div
      id="kt_header"
      className={`header ${
        theme[2].DesktopFixed === true ? "header-fixed" : ""
      }`}
    >
      {/*begin::Container*/}
      <div
        className={`${
          theme[2].Width === "fluid" ? "container-fluid" : "container"
      ...
      >
                ...
                <div className="menu-submenu menu-submenu-classic menu-submenu-left">
                  <ul className="menu-subnav">
                    <li
                      ...
                      aria-haspopup="true"
                    >
                      <a href="/keen/demo1/index.html" className="menu-link">
                        ...
                        <ul className="menu-subnav">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Latest Projects</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Urgent Projects</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                    ...
                    <ul className="menu-content">
                      <li className="menu-item">
                        <h3 className="menu-heading menu-toggle">
                          ...
                          <span className="menu-text">Task Reports</span>
                          <i className="menu-arrow" />
                        </h3>
                        <ul className="menu-inner">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Latest Tasks</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Pending Tasks</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Urgent Tasks</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Completed Tasks</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Failed Tasks</span>
                            </a>
                          </li>
                        </ul>
                      </li>
                      <li className="menu-item">
                        <h3 className="menu-heading menu-toggle">
                          ...
                          <span className="menu-text">Profit Margins</span>
                          <i className="menu-arrow" />
                        </h3>
                        <ul className="menu-inner">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Overall Profits</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Gross Profits</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Nett Profits</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Monthly Profits</span>
                            </a>
                          </li>
                        </ul>
                      </li>
                        ...
                        <ul className="menu-inner">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Top Management</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Executives</span>
                            </a>
                          </li>
                        </ul>
                      </li>
                      <li className="menu-item">
                        ...
                        <ul className="menu-inner">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              <span className="menu-text">Customer CRM</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                  ...
                  <ul className="menu-subnav">
                    ...
                    >
                      <a href="javascript:;" className="menu-link menu-toggle">
                        ...
                        <span className="menu-text">Social Presence</span>
                        <i className="menu-arrow" />
                      </a>
                      <div className="menu-submenu menu-submenu-classic menu-submenu-right">
                        <ul className="menu-subnav">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Reached Users</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">SEO Ranking</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Market Segments</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                    ...
                    >
                      <a href="javascript:;" className="menu-link menu-toggle">
                        ...
                        <span className="menu-text">Deployment Center</span>
                        <i className="menu-arrow" />
                      </a>
                      <div className="menu-submenu menu-submenu-classic menu-submenu-right">
                        <ul className="menu-subnav">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="javascript:;" className="menu-link">
                              ...
                              <span className="menu-text">Merge Branch</span>
                              <span className="menu-label">
        ...
        <div className="topbar">
          {/*begin::Search*/}
          <div className="dropdown mr-1" id="kt_quick_search_toggle">
            {/*begin::Toggle*/}
            <div
            ...
            >
              <div className="btn btn-icon btn-clean btn-lg btn-dropdown">
            ...
            <div className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
              <form>
                ...
                <div
                  ...
                  style={{
                    backgroundImage: "url(/assets/media/misc/bg-3.jpg)",
                  }}
                >
                  {/*begin::Title*/}
                  <h4 className="d-flex flex-center rounded-top">
                    <span className="text-white">Message Center</span>
                    <span className="btn btn-success btn-sm font-weight-bold ml-2">
                      25
                    </span>
                  </h4>
                  {/*end::Title*/}
                  {/*begin::Tabs*/}
                  <ul
                    className="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8 font-size-lg"
                    role="tablist"
                  >
                ...
                <div className="tab-content">
                    ...
                    >
                      ...
                      <div className="d-flex align-items-center mb-6">
                        ...
                        <div className="d-flex flex-wrap flex-row-fluid">
                          ...
                          <div className="d-flex flex-column pr-5 flex-grow-1">
                            <a
                              href="#"
                              className="text-dark text-hover-primary mb-1 font-weight-bold font-size-lg"
                            >
                              Marcus Smart
                            </a>
                      ...
                      <div className="d-flex align-items-center mb-6">
                        ...
                        <div className="d-flex flex-wrap flex-row-fluid">
                          ...
                          <div className="d-flex align-items-center py-2">
                            {/*begin::Label*/}
                            <span className="text-info font-weight-bolder font-size-sm pr-6">
                              +34%
                            </span>
                            {/*end::Label*/}
                            {/*begin::Btn*/}
                    ...
                    >
                      ...
                      <div className="d-flex align-items-center mb-6">
                        ...
                        <div className="d-flex flex-column font-weight-bold">
                          ...
                          <span className="text-muted">
                            Reporting Dashboard App Planning
                          </span>
                        </div>
                        {/*end::Text*/}
                      </div>
                  ...
                  >
                    {/*begin::Nav*/}
                    <div className="d-flex flex-center font-weight-bold text-center text-muted min-h-250px">
                      All caught up!
                      <br />
                      No new messages.
                    </div>
          ...
          <div className="dropdown mr-1">
            ...
            <div className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
              ...
              <div className="d-flex flex-column flex-center py-10 rounded-to border-bottom">
                <h4 className="text-dark font-weight-bold">Quick Actions</h4>
                <span className="btn btn-primary btn-sm font-weight-bold font-size-sm mt-2">
                  23 new tasks
                </span>
              </div>
              {/*end:Header*/}
          ...
          <div className="topbar-item ml-4">
            <div
              className="btn btn-icon btn-light-primary h-40px w-40px p-0"
              id="kt_quick_user_toggle"
            >
              <img
                src="/assets/media/svg/avatars/004-boy-1.svg"
                className="h-30px align-self-end"
                alt=""
              />
            </div>
            {/*
