...
import { removeToken } from '../../helpers/localStorageUser';
      ...
      <div id="kt_quick_user" className="offcanvas offcanvas-right p-10">
        ...
        <div className="offcanvas-header d-flex align-items-center justify-content-between pb-5">
          <h3 className="font-weight-bold m-0">
            Thông tin cá nhân
            <small className="text-muted font-size-sm ml-2">15 messages</small>
          </h3>
          <a
            href="#"
        ...
        <div className="offcanvas-content pr-5 mr-n5">
          ...
          <div className="d-flex align-items-center mt-5">
            <div className="symbol symbol-100 mr-5">
              <div
                ...
                style={{
                  backgroundImage: 'url("assets/media/users/150-6.jpg")',
                }}
              />
            ...
            <div className="d-flex flex-column">
              ...
              <div className="text-muted mt-1">Quản trị viên</div>
              <div className="navi mt-1">
                <Link href="#" className="navi-item">
          ...
          <div className="navi navi-spacer-x-0 p-0">
            {/*begin::Item*/}
            <Link to="/account" className="navi-item">
              <div className="navi-link">
                ...
                <div className="navi-text">
                  <div className="font-weight-bold">Tài khoản của tôi</div>
            ...
            {/*end:Item*/}
            {/*begin::Item*/}
            <Link to="/account/change-password" className="navi-item">
              <div className="navi-link">
                <div className="symbol symbol-40 bg-light mr-3">
                  <div className="symbol-label">
                    <span className="svg-icon svg-icon-md svg-icon-success">
                      {/*begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-02-21-151229/theme/demo1/dist/../src/media/svg/icons/Code/Lock-circle.svg*/}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                        width="24px"
            ...
            <a href="custom/apps/user/profile-2.html" className="navi-item">
              <div className="navi-link">
                ...
                <div className="navi-text">
                  <div className="font-weight-bold">My Events</div>
            ...
            >
              <div className="navi-link">
                ...
                <div className="navi-text">
                  <div className="font-weight-bold">My Statements</div>
            ...
            <span className="navi-item mt-2">
              <span className="navi-link">
                <button
                  type="button"
                  className="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6"
                  onClick={() => SignOut()}
                >
                  Sign Out
                </button>
          ...
          <div className="pt-5">
            {/*begin:Heading*/}
            <h5 className="mb-7">Recent Notifications</h5>
            {/*end:Heading*/}
            {/*begin::Item*/}
            <div className="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
              {/*begin::Icon*/}
              <div className="d-flex flex-center position-relative ml-4 mr-6 ml-lg-6 mr-lg-10">
                <span className="svg-icon svg-icon-4x svg-icon-primary position-absolute opacity-15">
                ...
                <span className="svg-icon svg-icon-lg svg-icon-primary position-absolute">
              ...
              <div className="ml-1">
                ...
                <p className="m-0 text-dark-50 font-weight-bold">
            ...
            <div className="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
              {/*begin::Icon*/}
              <div className="d-flex flex-center position-relative ml-4 mr-6 ml-lg-6 mr-lg-10">
                <span className="svg-icon svg-icon-4x svg-icon-danger position-absolute opacity-15">
                  {/*begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-polygon.svg*/}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="70px"
                ...
                <span className="svg-icon svg-icon-lg svg-icon-danger position-absolute">
            ...
            <div className="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
              {/*begin::Icon*/}
              <div className="d-flex flex-center position-relative ml-4 mr-6 ml-lg-6 mr-lg-10">
                <span className="svg-icon svg-icon-4x svg-icon-success position-absolute opacity-15">
                  {/*begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-polygon.svg*/}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="70px"
                ...
                <span className="svg-icon svg-icon-lg svg-icon-success position-absolute">
            ...
            <div className="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
              {/*begin::Icon*/}
              <div className="d-flex flex-center position-relative ml-4 mr-6 ml-lg-6 mr-lg-10">
                <span className="svg-icon svg-icon-4x svg-icon-info position-absolute opacity-15">
                  {/*begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-polygon.svg*/}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="70px"
                ...
                <span className="svg-icon svg-icon-lg svg-icon-info position-absolute">
